		...
		<div className={styles.ModalDialog}>
			<div className={styles.Modal}>
				...
				<div className={styles.ModalBody}>
					...
					dashboard. You can re-join the course to restore your progress at any point, but you will
					need to find it again in "Courses". Are you sure you would like to quit?
				</div>
